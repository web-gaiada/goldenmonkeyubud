            ...
            <div class="col-12">
                <style>
                    ...
                    .delivery-card-container .img-cover {
                        ...
                        z-index: 1;
                        filter: brightness(0.7); /* Darken bg a bit to pop logos */
                    }
                    ...
                    /* Platform Colors */
                    .bg-grabfood { background-color: #00b14f !important; }
                    .bg-gofood { background-color: #00aa13 !important; }
                        ...
                        <div class="container-fluid px-0">
                            <div class="row g-3 g-lg-4">
                                ...
                                <div class="col-12 col-md-6 col-lg-4">
                                    <div class="bg-dark position-relative delivery-card-container d-flex align-items-center justify-content-center">
                                            ...
                                            <div id="Delivery_Gloria_Food">
                                                <span data-glf-cuid="9e72489a-49f1-496d-a753-c535e7babe5b"
                                                    ...
                                                    <div class="d-block delivery-trigger" style="cursor:pointer;">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/images/home-delivery.png" alt="Home Delivery" class="img-fluid img-client">
                                                    </div>
                                                </span>
                                            </div>
                                        </div>
                                        <img src="<?php echo get_template_directory_uri(); ?>/images/delivery-background.jpg" class="img-cover position-absolute top-0 start-0 w-100 h-100 object-fit-cover">
                                    </div>
                                </div>
                                ...
                                <?php if (have_rows('image_list')): ?>
                                    ...
                                    ?>
                                        <div class="col-12 col-md-6 col-lg-4">
                                            <div class="<?php echo $bg_class; ?> position-relative delivery-card-container d-flex align-items-center justify-content-center">
                                                <div class="delivery-card-content text-center w-100">
                                                ...
                                                <img src="<?php echo esc_url($bg_url); ?>" class="img-cover position-absolute top-0 start-0 w-100 h-100 object-fit-cover" alt="Background">
                                            </div>
                                        </div>
                                    <?php endwhile; ?>
                                <?php endif; ?>
                        ...
                        <div class="container-fluid px-0">
                            <div class="row g-3 g-lg-4">
                                <?php if (have_rows('image_list_sanur')): ?>
                                    <?php while (have_rows('image_list_sanur')): the_row();
                                        $banner_id = get_sub_field('banner_id');
                                        $bg_class = 'bg-dark';
