...
<div class="bg-footer text-white white-link">
  <div class="container py-5">
    <div class="row py-3 py-lg-5 gy-5">
      ...
      <?php dynamic_sidebar( 'footer-add' ); ?> 
      </div>
            ...
            <div class="px-4 px-lg-0">
              <ul class="list-inline list-social">
                ...
                <a href="https://www.instagram.com/goldenmonkeyrestaurant/" target="_blank" aria-label="Instagram">
                  <img src="<?php bloginfo('template_url'); ?>/images/instagram-rounded-retangle.svg" alt="Follow us on Instagram" title="Instagram" width="45" height="45">
                </a>
                </li>
                <li class="list-inline-item">
                <a href="https://www.facebook.com/goldenmonkeyrestaurant" target="_blank" aria-label="Facebook">
                  <img src="<?php bloginfo('template_url'); ?>/images/facebook-logo-rounded-retangle.svg" alt="Follow us on Facebook" title="Facebook" width="45" height="45">
                </a>
                </li>
                <li class="list-inline-item">
                <a href="https://www.tripadvisor.com/Restaurant_Review-g297701-d10915653-Reviews-Golden_Monkey-Ubud_Gianyar_Regency_Bali.html" target="_blank" aria-label="TripAdvisor">
                  <img src="<?php bloginfo('template_url'); ?>/images/tripadvisor-rounded-retangle.svg" alt="Review us on Tripadvisor" title="Tripadvisor" width="45" height="45">
                </a>
                </li>
              </ul>
              <img src="<?php bloginfo('template_url'); ?>/images/credit-card.png" alt="Credit Card Payment Gateway" class="mb-2" height="30" width="261">
			  <div>
				...
				<a target="_blank" href="https://www.tripadvisor.com/Restaurant_Review-g297701-d10915653-Reviews-Golden_Monkey-Ubud_Gianyar_Regency_Bali.html" aria-label="Tripadvisor Award"><img height="90" width="90" src="https://www.goldenmonkeyubud.com/wp-content/uploads/2022/03/tripadvisor-award-white.webp" alt="Tripadvisor Award" ></a>
			  </div>
            </div>
          </div>
        </div>
...
<div class="bg-light py-3">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <div class="px-4 px-lg-0">
                &copy; <?php bloginfo('name'); ?> <?php echo date('Y'); ?>. <a href="https://www.gaiada.com/" target="_blank" aria-label="Developed by Gaia Digital Agency" style="color:#000">Developed by Gaia Digital Agency.</a></div>
      </div>
    </div>
  </div>
</div>
                ...
                <div class="item px-4">
                    <div class="inner">
                        <a href="https://www.goldenmonkeyubud.com/delivery/">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="#7c8ea3" width="20" height="20" viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z"/></svg>
                        </a>
                    </div>
                </div>
                <div class="item px-4">
                    <div class="inner">
                        <a href="https://www.google.com/maps?gs_lcrp=EgZjaHJvbWUqDAgAECMYJxiABBiKBTIMCAAQIxgnGIAEGIoFMhAIARAuGK8BGMcBGIAEGI4FMgYIAhBFGDkyBwgDEAAYgAQyBwgEEAAYgAQyBggFEEUYPDIGCAYQRRg8MgYIBxBFGDyoAgCwAgA&um=1&ie=UTF-8&fb=1&gl=id&sa=X&geocode=KT_WyXdsPdItMesxnVlwLT8J&daddr=Jl.+Dewisita,+Ubud,+Kecamatan+Ubud,+Kabupaten+Gianyar,+Bali+80571">
                ...
                <div class="item px-4">
                    <div class="inner">
                        <a href="https://www.goldenmonkeyubud.com/reservations/">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="#7c8ea3" width="20" height="20" viewBox="0 0 384 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M0 48V487.7C0 501.1 10.9 512 24.3 512c5 0 9.9-1.5 14-4.4L192 400 345.7 507.6c4.1 2.9 9 4.4 14 4.4c13.4 0 24.3-10.9 24.3-24.3V48c0-26.5-21.5-48-48-48H48C21.5 0 0 21.5 0 48z"/></svg>
                        </a>
                    </div>
                </div>
                <div class="item px-4">
                    <div class="inner">
                        <a href="https://api.whatsapp.com/send/?phone=628113866001&text=Golden+Monkey%21+I%27m+craving+for+the+best+Chinese+food+in+town...+&type=phone_number&app_absent=0">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="#7c8ea3" width="25" height="25" viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M380.9 97.1C339 55.1 283.2 32 223.9 32c-122.4 0-222 99.6-222 222 0 39.1 10.2 77.3 29.6 111L0 480l117.7-30.9c32.4 17.7 68.9 27 106.1 27h.1c122.3 0 224.1-99.6 224.1-222 0-59.3-25.2-115-67.1-157zm-157 341.6c-33.2 0-65.7-8.9-94-25.7l-6.7-4-69.8 18.3L72 359.2l-4.4-7c-18.5-29.4-28.2-63.3-28.2-98.2 0-101.7 82.8-184.5 184.6-184.5 49.3 0 95.6 19.2 130.4 54.1 34.8 34.9 56.2 81.2 56.1 130.5 0 101.8-84.9 184.6-186.6 184.6zm101.2-138.2c-5.5-2.8-32.8-16.2-37.9-18-5.1-1.9-8.8-2.8-12.5 2.8-3.7 5.6-14.3 18-17.6 21.8-3.2 3.7-6.5 4.2-12 1.4-32.6-16.3-54-29.1-75.5-66-5.7-9.8 5.7-9.1 16.3-30.3 1.8-3.7 .9-6.9-.5-9.7-1.4-2.8-12.5-30.1-17.1-41.2-4.5-10.8-9.1-9.3-12.5-9.5-3.2-.2-6.9-.2-10.6-.2-3.7 0-9.7 1.4-14.8 6.9-5.1 5.6-19.4 19-19.4 46.3 0 27.3 19.9 53.7 22.6 57.4 2.8 3.7 39.1 59.7 94.8 83.8 35.2 15.2 49 16.5 66.6 13.9 10.7-1.6 32.8-13.4 37.4-26.4 4.6-13 4.6-24.1 3.2-26.4-1.3-2.5-5-3.9-10.5-6.6z"/></svg>
                        </a>
                    </div>
                </div>
            </div>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-53QR2DZ"
