...
<div class="position-fixed bottom-0 start-0 end-0 d-lg-none d-none bg-footer">
  <div class="pt-4 pb-2 d-flex justify-content-center">
    <div class="item px-4">
      <div class="inner">
        <a href="https://www.goldenmonkeyubud.com/delivery/" aria-label="Delivery">
          <svg xmlns="http://www.w3.org/2000/svg" fill="#7c8ea3" width="20" height="20"
            viewBox="0 0 512 512" aria-hidden="true"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
            <path
    ...
    <div class="item">
      <div class="inner pb-4 ps-4 pe-4 pt-3 bg-footer" style="margin-top: -40px; border-radius: 50%;">
        <div class="inner p-3" style="background-color: #54acd3; border-radius: 50%;">
          <a href="https://www.goldenmonkeyubud.com/menu/" aria-label="View Menu">
            <svg xmlns="http://www.w3.org/2000/svg" fill="#fff" width="30" height="30"
              viewBox="0 0 576 512" aria-hidden="true"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
              <path
    ...
    <div class="item px-4">
      <div class="inner">
        <a href="https://www.goldenmonkeyubud.com/reservations/" aria-label="Reservations">
          <svg xmlns="http://www.w3.org/2000/svg" fill="#7c8ea3" width="20" height="20"
            viewBox="0 0 384 512" aria-hidden="true"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
            <path
    ...
    <div class="item px-4">
      <div class="inner">
        <a
          href="https://api.whatsapp.com/send/?phone=628113866001&text=Golden+Monkey%21+I%27m+craving+for+the+best+Chinese+food+in+town...+&type=phone_number&app_absent=0" aria-label="Chat on WhatsApp">
          <svg xmlns="http://www.w3.org/2000/svg" fill="#7c8ea3" width="25" height="25"
            viewBox="0 0 448 512" aria-hidden="true"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
            <path
