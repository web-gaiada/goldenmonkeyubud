...
get_header();
?>
<link rel='stylesheet' id='joinchat-css' href='https://www.goldenmonkeyubud.com/wp-content/plugins/creame-whatsapp-me/public/css/joinchat.min.css?ver=6.0.10' media='all' />
<style>
    ...
    <div class="position-absolute top-50 start-50 translate-middle text-center text-white">
      ...
      <?php if( have_rows('header_button') ): ?>
        <?php while ( have_rows('header_button') ) : the_row(); ?>
          <a href="<?php bloginfo('url')?><?php the_sub_field('button_link');?>" class="btn btn-outline-light rounded-0 btn-lg mt-5" arial-label="Golden Monkey Ubud"><?php the_sub_field('button_text');?></a>
        <?php endwhile; ?>
      <?php endif; ?>      
    </div>
...
<?php if(get_field('popup_title')): ?>
  <div class="modal fade" id="GoldenMonkeyOffer" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="GoldenMonkeyOfferLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">            
        <div class="modal-body text-white text-center px-lg-5">
          ...
          <a href="<?php the_field('popup_link'); ?>" class="btn btn-light text-uppercase fw-bold py-2 px-3" aria-label="Golden Monkey Popup"><?php the_field('popup_button_text'); ?></a>
			<span class="mx-2 fs-5 d-block d-lg-inline">OR</span>
		  <a href="<?php the_field('popup_link2'); ?>" class="btn btn-light text-uppercase fw-bold py-2 px-3" aria-label="Golden Monkey Popup"><?php the_field('popup_button_text2'); ?></a>
        </div>      
      </div>
    </div>
  </div>
